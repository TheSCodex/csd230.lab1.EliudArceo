...
class MagazineRepositoryTests {
    ...
    void testAddMagazineToCart() {
        ...
        Magazine magazine = new Magazine(19.99, 5, "A great magazine", "Tech Monthly", 50, 3, new Date());
    ...
    void testSaveAndFindMagazineById() {
        Magazine magazine = new Magazine(9.99, 10, "A magazine description", "Science Weekly", 100, 5, new Date());
        magazineRepository.save(magazine);
    ...
    void testFindAllMagazines() {
        ...
        Magazine magazine1 = new Magazine(9.99, 10, "Magazine 1 description", "Magazine 1", 100, 5, new Date());
        Magazine magazine2 = new Magazine(14.99, 20, "Magazine 2 description", "Magazine 2", 50, 10, new Date());
    ...
    void testDeleteMagazine() {
        Magazine magazine = new Magazine(9.99, 10, "Magazine description", "Science Today", 100, 5, new Date());
        magazineRepository.save(magazine);
